...
%    Tot = Tot +    abs((Effort(i)- ((x(1)* (KDLOC(i)^x(2) )))));
Tot = Tot +   abs((Effort(i)-(x(1)* KDLOC(i)^x(2) + x(3)*ME(i) )));
% Tot = Tot +   abs((Effort(i)-(x(1)* KDLOC(i)^x(2) + x(3)*ME(i) + x(4) )));
...
%                
               ...
               ylabel('Best Objective Value' ,'fontsize',20)   ;set(gca,'FontSize',15)
%                ylim([-2,15])
%                 'MarkerEdgeColor','k',...
%                 'MarkerFaceColor','b',...
%%%------------------------------------------                
